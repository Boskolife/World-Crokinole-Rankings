...
import { getEventById, getEventRegisteredPlayers } from "@/shared/supabase/data";
import { localeConfig } from "@/app/localization/config";
import { EnterEventResultsForm } from "@/widgets/events/enter-event-results-form/EnterEventResultsForm";
...
export default function EventResultsPage() {
    ...
    useEffect(() => {
        ...
        Promise.all([getEventById(id), getEventRegisteredPlayers(id)]).then(
            ([e, pl]) => {
                setEvent(e ?? null);
                setPlayers(pl ?? []);
                setNotFound(!e);
