    ...
    return (
        <div className={css.popup_backdrop} onClick={handleBackdropClick}>
            ...
            >
                ...
                {isPopupOpen("club-delete-confirm") && (
                    <ClubDeleteConfirmPopup />
                )}
                ...
                {isPopupOpen("edit-member-access") && (
                    <EditMemberAccessPopup />
                )}
                {isPopupOpen("invite-member") && (
                    <InviteMemberPopup />
                )}
                {isPopupOpen("view-heat-participants") && (
                ...
                {isPopupOpen("leave-event-confirm") && (
                    <LeaveEventConfirmPopup />
                )}
